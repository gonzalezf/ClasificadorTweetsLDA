...
public class TopicModel 
{
	...
	public static void analyzeTwitterUser(String username, int numTopics)
	{
		...
		//String jsonFile = String.format("viz/d3bubble/json/%s.json", username);
		String jsonFile = 
				String.format("viz/static/json/%s.json", username);
	...
	public static void toJSON(String outFile, String[][] topWords)
	{
		...
		{
			outFile = s+"/"+outFile;
			System.out.println("OUTFILE PATH ======= "+outFile);
	...
	{
		String username = "MuckZuckerburg";
		int numTopics = 25; //20
		int numTweets = 2000; //1000
